---
title: "Profile Summary (GL)"
description: |
  Profile summary report generated from a single Parquet file has been created from around 550 NetCDF files from the Arctic Ocean in situ NRT observations.
output:
...
r_func_path <- "./_func"
r_funcs <- c("libraries.Rmd", "common.Rmd", "common_ar_gl.Rmd", "summary_common.Rmd")
```
